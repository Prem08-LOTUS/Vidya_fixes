...
# "GEMINI 3" - using the preview model found in the list
...
def run_audit():
    ...
    # Limit payload to avoid token limits if necessary, though 1M is plenty.
    # codebase_dump.txt was 200k chars, easy fit.
