...
# Using the specific preview model identified in models.json
...
def run_audit():
    ...
    # AGNIX AI AUDIT REPORT (GEMINI 3 PRO)
    ## Critical Findings
    1. **Title**
    ...
    try:
        with urllib.request.urlopen(req) as response:
            ...
            try:
                ...
                with open('gemini_audit_report_pro.md', 'w', encoding='utf-8') as f:
                    f.write(report_text)
                print("Audit Complete. Report saved to gemini_audit_report_pro.md")
                print("-" * 20)
                print(report_text)
                print("-" * 20)
